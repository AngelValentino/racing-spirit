  ...
  return ( 
    <nav className="faqs-nav">
      ...
      <div className="faqs-title__search-input-container">
        ...
        <svg ref={searchIcon} aria-hidden="true" focusable="false" role="presentation" className="faqs-title__search-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
        ...
        <button title="Clear search" ref={closeBtn} className="faqs-title__close-icon-btn" aria-label="Clear search input." onClick={clearSearchInput}>
