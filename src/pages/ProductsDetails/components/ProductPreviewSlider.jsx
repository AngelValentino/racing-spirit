  ...
  return ( 
    <section aria-roledescription="carousel" className="product-slider">
      ...
      <div className="slider-controls">
        <button aria-controls="slider-controls__carousel" ref={prevBtn} className="slider-controls__prev-btn" aria-label="Show previous image." onClick={slideLeft}>
        ...
        <ul id="slider-controls__carousel" role="tablist" ref={carousel} className="slider-controls__carousel" onScroll={handleScroll}>
          <ProductThumbsList 
            jacket={jacket}
            imgIndex={imgIndex}
        ...
        <button aria-controls="slider-controls__carousel" ref={nextBtn} className="slider-controls__next-btn" aria-label="Show next image." onClick={slideRight}>
