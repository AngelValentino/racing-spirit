const SlideMenuSocialLinks = () => {
  return ( 
  <ul>
    <li>
      <a aria-label="Follow Racing Spirit on Instagram." className="slide-menu-social-icons__instagram-link" title="Racing Spirit on Instagram" target="_blank" href="https://www.instagram.com/">
    ...
    <li>
      <a aria-label="Follow Racing Spirit on Facebook." className="slide-menu-social-icons__facebook-link" title="Racing Spirit on Facebook" target="_blank" href="https://www.facebook.com/">
        <svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <li>
      <a aria-label="Follow Racing Spirit on Twitter" className="slide-menu-social-icons__twitter-link" title="Racing Spirit on Twitter" target="_blank" href="https://x.com/">
        <svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <li>
      <a aria-label="Follow Racing Spirit on YouTube." className="slide-menu-social-icons__youtube-link" title="Racing Spirit on YouTube" target="_blank" href="https://www.youtube.com/">
        <svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export default SlideMenuSocialLinks;