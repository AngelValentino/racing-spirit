const PaymentsList = () => {
  return ( 
    <ul className="list-payments">
      <li className="list-payment__item">
        <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24" width="38" height="24"
          ...
          <path d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z" fill="#000"
            fillRule="nonzero" opacity=".07"></path>
      ...
      <li className="list-payment__item">
        <svg xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pi-american_express" viewBox="0 0 38 24"
          width="38" height="24">
      ...
      <li className="list-payment__item">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" x="0" y="0" width="38" height="24"
          viewBox="0 0 165.521 105.965" xmlSpace="preserve" aria-labelledby="pi-apple_pay">
      ...
      <li className="list-payment__item">
        <svg viewBox="-36 25 38 24" xmlns="http://www.w3.org/2000/svg" width="38"
      ...
      <li className="list-payment__item">
        <svg xmlns="http://www.w3.org/2000/svg" role="img" width="38" height="24"
          ...
          <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            ...
            <path
              ...
              fill="#0A0B09" fillRule="nonzero"></path>
          </g>
        </svg>
      </li>
    </ul>
